...
export default function ForWhoClient() {
  const segments = [
    {
      title: "Restauracje",
      description: (
    ...
    },
    {
      ...
      description: (
        <>
          Foodtrucki zyskują dzięki marketingu lokalnemu i <Link href="/uslugi/social-media">social media</Link>, które pokazują dokładnie, gdzie jesteś. Tworzymy zdjęcia, krótkie filmy, <Link href="/uslugi/kampanie-reklamowe">kampanie lokalne</Link> i strategie contentowe, aby klienci wiedzieli, kiedy Cię znaleźć.
        </>
      ),
      icon: (
        <svg fill="none" viewBox="0 0 24 24" stroke="currentColor">
